    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="/" class="logo">
                ...
                <span class="logo-lg">STASH</b></span>
            </a>
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('/supplyer')}}"><i class="fa fa-clone"></i> Manage suppliers</a></li>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2019 <a href="https://github.com/sangit0">KHRR</a>.</strong> All rights reserved.
        </footer>
